...
const translations = {
  "pt-BR": {
    ...
    aboutText: "Sou um Software Engineer com foco em frontend e desenvolvimento full stack, apaixonado por transformar problemas reais em aplicações web claras, responsivas e funcionais. Trabalho principalmente com React, TypeScript, Next.js, Node.js, Python, Django, APIs REST e bancos de dados relacionais.",
  ...
  en: {
    ...
    aboutText: "I am a frontend-focused Software Engineer who also works across the full stack, passionate about turning real problems into clear, responsive and functional web applications. I mainly work with React, TypeScript, Next.js, Node.js, Python, Django, REST APIs and relational databases.",
  ...
  es: {
    ...
    aboutText: "Soy Software Engineer enfocado en frontend y desarrollo full stack, apasionado por transformar problemas reales en aplicaciones web claras, responsivas y funcionales. Trabajo principalmente con React, TypeScript, Next.js, Node.js, Python, Django, APIs REST y bases de datos relacionales.",
