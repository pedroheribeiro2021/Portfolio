...
const translations = {
  "pt-BR": {
    ...
    aboutText: "Sou um Software Engineer com foco em frontend, apaixonado por transformar problemas reais em aplicações web claras, responsivas e funcionais. Trabalho principalmente com React, TypeScript, Next.js, Node.js, Python, APIs REST e bancos relacionais.",
    aboutText2: "Tenho experiência com interfaces fiéis a layouts do Figma, componentes reutilizáveis, integrações e entrega ponta a ponta. Busco oportunidades remotas para colaborar com times de produto e engenharia.",
  ...
  en: {
    ...
    aboutText: "I am a frontend-focused Software Engineer passionate about turning real problems into clear, responsive and functional web applications. I mainly work with React, TypeScript, Next.js, Node.js, Python, REST APIs and relational databases.",
    aboutText2: "I have experience implementing Figma designs accurately, building reusable components, integrations and end-to-end delivery. I am looking for remote opportunities to collaborate with product and engineering teams.",
  ...
  es: {
    ...
    aboutText: "Soy Software Engineer enfocado en frontend y apasionado por transformar problemas reales en aplicaciones web claras, responsivas y funcionales. Trabajo principalmente con React, TypeScript, Next.js, Node.js, Python, APIs REST y bases de datos relacionales.",
    aboutText2: "Tengo experiencia implementando diseños de Figma con precisión, componentes reutilizables, integraciones y entregas de punta a punta. Busco oportunidades remotas para colaborar con equipos de producto e ingeniería.",
